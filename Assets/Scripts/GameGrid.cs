...
public class GameGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < xDim; i++)
        {
            ...
            {
                GameObject background = (GameObject)Instantiate(backgroundPrefab, GetWorldPosition(i, j), Quaternion.identity);
    ...
    {
        return new Vector2(transform.position.x - (xDim / 2.0f) + x, transform.position.y - (yDim / 2.6f) + y);
    }
